        ...
        <div class="row text-center">
            <div class="col-sm-6">
                ...
                ?>
                    ...
                    <a class="btn btn-dark text-white" onclick=filterTable(<?php echo '"'.$row_list_genre['id'].'"';?>)>
            ...
            <div class="col-sm-6 text-right mt-2">
                <div class="row">
                    <div class="col-sm">
                        <form action="includes/add_director.inc.php" method="POST">
                            <div class="form-row">
                                <div class="col">
                                    <input type="text" name="director_name" class="form-control" placeholder="Masukkan nama director baru">
                                </div>
                                <button type="submit" name="submit_add" class="btn btn-primary" >Add NEW director</button>
                            </div>
                        </form>
                    </div>
                </div>

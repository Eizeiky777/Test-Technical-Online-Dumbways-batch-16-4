    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-sm-6 text-right mt-2">
                <div class="row">
                    <div class="col-sm">
                        <form action="includes/add_writer.inc.php" method="POST">
                            <div class="form-row">
                                <div class="col">
                                    <input type="text" name="writer_name" class="form-control" placeholder="Masukkan nama writer baru">
                                </div>
                                <button type="submit" name="submit_add" class="btn btn-primary" >Add NEW Writer</button>
                            </div>
                        </form>
                    </div>
                </div>
